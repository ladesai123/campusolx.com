  ...
  return (
    <div className="bg-white p-8 rounded-xl shadow-lg max-w-2xl mx-auto mb-12">
      <div className="flex flex-col items-center mb-6">
        ...
        />
        <h3 className="text-2xl font-bold text-slate-900">Lade Sai Teja</h3>
        <p className="text-blue-600 font-semibold">BTech Final Year</p>
      </div>
      
      {/* Short version */}
      {!isExpanded && (
        <div>
          <p className="text-slate-700 mb-6 text-left">
            "Every year, I'd see piles of useful things—books, lamps, cycles—just left behind or tossed away. 
            It hurt to watch so much go to waste, knowing someone right here on campus could have used it. 
            That's when I decided to create CampusOLX..."
          </p>
          <Button 
      ...
      {isExpanded && (
        <div>
          <div className="text-slate-700 text-left space-y-4 mb-6">
            <p>
          ...
          <div className="text-right text-blue-700 font-semibold mb-4">
