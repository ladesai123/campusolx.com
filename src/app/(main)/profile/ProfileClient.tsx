...
export default function ProfileClient({ profile, userProducts, savedProducts, userRequests }: ProfileClientProps) {
    ...
    return (
        <div className="w-full flex flex-col items-center px-2 py-8">
            ...
            {/* Profile card with Member Since badge */}
            <div className="w-full max-w-2xl bg-white rounded-2xl shadow-lg flex items-center gap-6 px-6 py-6 mb-10 border border-slate-100">
